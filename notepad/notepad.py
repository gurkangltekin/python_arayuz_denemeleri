import sys
import os
from PyQt5.QtWidgets import QWidget, QApplication, QTextEdit, QLabel, QPushButton, QVBoxLayout, QFileDialog, QHBoxLayout, QAction, QMainWindow, qApp
...
class Notepad(QWidget):
    ...
    def init_ui(self):
        ...
        self.ac.clicked.connect(self.dosyayi_ac)
